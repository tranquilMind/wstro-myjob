					...
					<div class="dropdown profile-element">
						...
						<span class="default-avatar"> 
						     ...
						     <a data-toggle="dropdown" class="dropdown-toggle" href="javascript:void(0);">
						       <span class="clear"> 
									...
									<span class="text-muted text-xs block">${admin.email}
									     <b class="caret"></b>
									</span>
						     </span>
						</a>
						<ul class="dropdown-menu animated fadeInRight m-t-xs">
							<li><a class="J_menuItem"
								href="${rc.contextPath}/admin/sys/user/view" data-index="1">个人资料</a></li>
							<li><a class="J_menuItem"
								href="${rc.contextPath}/admin/sys/user/avatar.html"
								data-index="1">修改头像</a></li>
							<li class="divider"></li>
							<li><a href="${rc.contextPath}/admin/sys/logout">安全退出</a></li>
						</ul>
					</div>
				</li> [#list menuList as list]
				<li><a href="javascript:void(0);" aria-expanded="false"> <i
						class="${list.icon}"></i> <span class="nav-label">${list.name}</span>
						<span class="fa arrow"></span>
				</a>
					<ul class="nav nav-second-level collapse" aria-expanded="false"
						style="height: 0px;">

						[#if list.list??] [#list list.list as children]
						<li><a class="J_menuItem"
							href="${rc.contextPath}/${children.url}"
	...
	<div id="page-wrapper" class="gray-bg dashbard-1">
			...
			<nav class="navbar navbar-static-top" role="navigation"
				...
				<ul class="nav navbar-top-links navbar-right">
                        <li class="dropdown">
                         ...
                         <li class="dropdown">                           
                                <a href="${rc.contextPath}/admin/sys/logout" class="dropdown-toggle count-info">
		...
		<div class="row J_mainContent" id="content-main">
			<iframe class="J_iframe" name="iframe0" width="100%" height="100%"
				src="${rc.contextPath}/admin/home.html" frameborder="0" data-id=""
				seamless></iframe>
		</div>
		<div class="footer">
			<div class="pull-right">
				© 2017-2018<a href="javascript:void(0);" target="_Blank"> ### </a>
			</div>
		</div>
	</div>
  [#--在线聊天 --]
