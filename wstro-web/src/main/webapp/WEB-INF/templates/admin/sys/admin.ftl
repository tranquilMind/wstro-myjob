            ...
            <div class="ibox-content form-horizontal">
                <form id="form">
                    ...
                    <div class="form-group m-t">
                        ...
                        <div class="col-sm-4">
                            <input type="text" maxlength="15" class="form-control" name="userCode">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" id="role" class="form-control" name="role" readonly="readonly">
                            <input type='hidden'  id="roleId" name="roleId"/>
                        </div>
                        <button type="button" style="margin-right:10px;" class="btn btn-primary"
                                 title="选择角色" onclick="chooseRole($('#showRoleList'))"><i
                                 class="glyphicon glyphicon-search"></i> 选择
                         </button>
                         <button type="button" style="margin-right:10px;" class="btn btn-primary"
                                 title="清空角色" onclick="removeRole($('#role'))"><i
                                 class="glyphicon glyphicon-share-alt"></i> 清空
                         </button>
                    </div>
                    <div class="hr-line-dashed"></div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="col-sm-12 text-center">
                            <button type="button" class="btn btn-success" onclick="saveOrUpdate(this);"><i
    ...
    <div class="col-sm-12">
        <div class="ibox float-e-margins">
            <div class="ibox-content form-horizontal">
                    ...
                    <div class="hr-line-dashed"></div>
                    <div class="col-sm-12 text-center">
                            <button type="button" class="btn btn-success" onclick="chooseSubmit($('#Roletable'))"><i
