...
public class SysUserController extends AbstractController {
	...
	public R list(Integer offset, Integer limit, String sort, String order,
		...
		String useCode = null;
		String email = null;
		Map<String, String> searchList = parseObject(search, "q_userCode", "q_email");
		if (null != searchList) {
		...
		Page<SysUserEntity> adminList = sysUserService.queryListByPage(offset, limit, email, useCode, sort, flag);
	...
	public R save(@RequestParam("roleId") String[] roleIds, @Valid SysUserEntity user, BindingResult result)
			throws Exception {
